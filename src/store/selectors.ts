...
export const selectFavorites = (state: RootState): Offer[] =>
  state.offers.favorites;

export const selectFavoriteCount = (state: RootState): number =>
  state.offers.favorites.length;
...
export const selectOfferPageOffer = (
  state: RootState
): Offer | null =>
  state.offerPage.offer;

export const selectOfferPageNearby = (
  state: RootState
): Offer[] =>
  state.offerPage.nearby;

export const selectOfferPageReviews = (
  state: RootState
): Review[] =>
  state.offerPage.reviews;

export const selectOfferPageLoading = (
  state: RootState
): boolean =>
  state.offerPage.isLoading;

export const selectOfferPagePosting = (
  state: RootState
): boolean =>
  state.offerPage.isPosting;

export const selectOfferPageNotFound = (
  state: RootState
): boolean =>
  state.offerPage.notFound;
